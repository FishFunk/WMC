...
e.days(_.sortBy(e.days(),function(e){return e.date})),console.log(e.days())}).fail(function(e){return console.log(e)}).always(function(){return spinner.Hide()})}}},{key:"DeleteOld",value:function(){if(this.loginVm.VerifyUser){var e=this
