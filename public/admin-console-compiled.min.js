...
for(var i in t)t.hasOwnProperty(i)&&e.days.push(new Day(i,t[i]))}).fail(function(e){return console.log(e)}).always(function(){return spinner.Hide()})}}},{key:"DeleteOld",value:function(){if(this.loginVm.VerifyUser){var e=this
