...
this.carYear=ko.observable(this.carYears[1]),this.first=ko.observable(""),this.last=ko.observable(""),this.email=ko.observable(""),this.phone=ko.observable(""),this.showAddLocationForm=ko.observable(!1),this.locations=ko.observableArray([]),this.locationTitleOptions=["Home","Work","Other"],this.title=ko.observable(this.locationTitleOptions[0]),this.street=ko.observable(""),this.city=ko.observable(""),this.state=ko.observable(""),this.zip=ko.observable(this.storageHelper.ZipCode),this.hideSubscriptionForm=ko.observable(!0),this.subIntervals=[1,2,3,4,5,6],this.selectedSubInterval=ko.observable(this.subIntervals[1]),this.subSpans=[{days:1,display:"Day(s)"},{days:7,display:"Week(s)"},{days:28,display:"Month(s)"}],this.selectedSubSpan=ko.observable(this.subSpans[1]),this.couponCode=ko.observable(""),this.coupon=ko.observable(null),this.orderTotal=ko.computed(function(){var e=0,t=parseFloat(n.WASH_COST+(n.addShine()?n.TIRE_SHINE_COST:0)+(n.addWax()?n.WAX_COST:0)+(n.addInterior()?n.INTERIOR_COST:0))
...
if(null!=e.appointments?e.appointments.push(i):e.appointments=[i],!this.hideSubscriptionForm())for(var n=new Date(i.date),o=this.selectedSubInterval()*this.selectedSubSpan().days,r=Math.round(365/o),a=o,s=0;r>s;s++){var l=this._makeAppointmentSchema(),c=new Date(n)
c.setDate(n.getDate()+a),l.date=c,e.appointments.push(l),a+=o}e.cars=this.cars(),e.phone=this.phone(),e.locations=this.locations(),e.firstName=this.first(),e.lastName=this.last(),this.webSvc.UpdateUser(e).then(function(){return t(null,e.email,i)}).fail(function(e){return t(e)})}},{key:"_prePopulateUserData",value:function(){var e=this.storageHelper.LoggedInUser
...
Constants.MORNING_TIME_RANGE.disabled(_.reduce(a,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=11),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(s,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=14),Constants.EVENING_TIME_RANGE.disabled(_.reduce(l,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=17),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(c,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=20)
