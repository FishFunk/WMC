...
window.jQuery(document).ready(function(e){try{Bootstrapper.Run().then(function(){var t=setTimeout(function(){e("#splash").fadeOut(1e3),clearTimeout(t)},1e3)}).fail(function(t){console.error(t),e("#splash").append("<div><h3>Website under maintenance. We apologize for the inconvenience</h3></div>")})}catch(t){console.error(t)}})
var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
...
else if(99==n.coupon().discountPercentage)e=.01
