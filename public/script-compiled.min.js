...
spinner.Show(),async.series([e?this._executeCharge.bind(this,e):function(e){e()},this._verifyUser.bind(this),this._updateUserData.bind(this),this._sendEmailConfirmation.bind(this)],function(e){e?t._onOrderFailure(e):t._onOrderSuccess()})}catch(i){this._onOrderFailure(i)}}},{key:"_onOrderFailure",value:function(e){this.$orderFormModal.modal("hide"),setTimeout(function(){spinner.Hide(),dialogPresenter.ShowOrderFailure(),console.log(e)},200)}},{key:"_onOrderSuccess",value:function(){this.OnFormCancel(),setTimeout(function(){spinner.Hide(),dialogPresenter.ShowOrderSuccess()},200)}},{key:"_sendEmailConfirmation",value:function(e){this.webSvc.SendConfirmationEmail(this.storageHelper.LoggedInUser.email,this.storageHelper.LoggedInUser.appointments).then(function(){return e()}).fail(function(t){return e(t)})}},{key:"_verifyUser",value:function(e){var t=this
