...
return this.addWash()&&(e+=Configuration.WASH_DETAILS.time),this.addShine()&&(e+=Configuration.TIRE_SHINE_DETAILS.time),this.addWax()&&(e+=Configuration.WAX_DETAILS.time),this.addInterior()&&(e+=Configuration.INTERIOR_DETAILS.time),e}},{key:"_buildServicesArray",value:function(){var e=[]
