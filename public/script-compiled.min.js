"use strict"
function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var a=t[i]
a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,i,a){return i&&e(t.prototype,i),a&&e(t,a),t}}(),Bootstrapper=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"Run",value:function(){function e(){var e=$(this),t=e.find(".modal-dialog")
e.css("display","block"),t.css("margin-top",Math.max(0,($(window).height()-t.height())/2))}var t=$.Deferred()
return $(".navbar-collapse ul li a").click(function(){$(".navbar-toggle:visible").click()}),$("body").scrollspy({target:".navbar-fixed-top"}),$(".modal").on("show.bs.modal",e),$(window).on("resize",function(){$(".modal:visible").each(e)}),async.series([function(e){$("#order-form-tmpl").load("./templates/order-form-tmpl.html",function(t,i,a){"error"===i?e("Application failed to initialize."):e()})},function(e){$("#vehicle-tmpl").load("./templates/vehicle-tmpl.html",function(t,i,a){"error"===i?e("Application failed to initialize."):e()})},function(e){$("#location-tmpl").load("./templates/location-tmpl.html",function(t,i,a){"error"===i?e("Application failed to initialize."):e()})},function(e){var t=new LocalStorageHelper(sessionStorage),i=new WebService,a=new OrderFormViewModel(t,i),o=new LogInViewModel(t,i),r=new MainViewModel(t,o,a)
ko.applyBindings(r),i.GetAllAppointments().then(function(i){var a=_.groupBy(i,function(e){return moment(e.date).format("MM/DD/YYYY")})
t.AppointmentsByDate=a,e()}).fail(function(t){e(t)})}],function(e){e?t.reject(e):t.resolve()}),t.promise()}}]),e}(),cbpAnimatedHeader=function(){function e(){window.addEventListener("scroll",function(e){r||(r=!0,setTimeout(t,250))},!1)}function t(){var e=i()
e>=n?classie.add(o,"navbar-shrink"):classie.remove(o,"navbar-shrink"),r=!1}function i(){return window.pageYOffset||a.scrollTop}var a=document.documentElement,o=document.querySelector(".navbar-default"),r=!1,n=300
e()}()
!function(e){function t(e){return new RegExp("(^|\\s+)"+e+"(\\s+|$)")}function i(e,t){var i=a(e,t)?r:o
i(e,t)}var a,o,r
"classList"in document.documentElement?(a=function(e,t){return e.classList.contains(t)},o=function(e,t){e.classList.add(t)},r=function(e,t){e.classList.remove(t)}):(a=function(e,i){return t(i).test(e.className)},o=function(e,t){a(e,t)||(e.className=e.className+" "+t)},r=function(e,i){e.className=e.className.replace(t(i)," ")})
var n={hasClass:a,addClass:o,removeClass:r,toggleClass:i,has:a,add:o,remove:r,toggle:i}
"function"==typeof define&&define.amd?define(n):e.classie=n}(window)
var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var a=t[i]
a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,i,a){return i&&e(t.prototype,i),a&&e(t,a),t}}(),ORDER_SUCCESS_MSG="Thank you! Your order has been placed. Please check your email for confirmation.",ORDER_FAILURE_MSG="We're really sorry about this... Looks like there was a problem submitting your order. Please contact us for support.",BAD_ZIP_MSG=s.sprintf("Sorry about this but we don't service your area yet! We're still young and growing so check back soon. Feel free to <a href=%s>contact us</a> to expedite the process. <BR><BR> Sincerely, <BR> - The WMC Team","javascript:$('.modal').modal('hide');$('#contact-nav').click();"),ASYNC_INTERUPTION_MARKER="ASYNC_INTERUPTION_MARKER",DEFAULT_JOB_TIME_MINS=120,MAX_JOB_TIME_PER_DAY_MINS=720,MAX_JOB_TIME_PER_INTERVAL=180,WASH_DETAILS={title:"Hand wash",time:30,price:29},TIRE_SHINE_DETAILS={title:"Tire shine",time:30,price:25},INTERIOR_DETAILS={title:"Interior cleaning",time:50,price:75},WAX_DETAILS={title:"Hand wax & buff",time:50,price:50},MORNING_TIME_RANGE={range:"9:00 - 12:00 PM",key:1,disabled:ko.observable(!1)},AFTERNOON_TIME_RANGE={range:"12:00 - 3:00 PM",key:2,disabled:ko.observable(!1)},EVENING_TIME_RANGE={range:"3:00 - 6:00 PM",key:3,disabled:ko.observable(!1)},NIGHT_TIME_RANGE={range:"6:00 - 9:00 PM",key:4,disabled:ko.observable(!1)},CAR_SIZES=[{size:"Compact (2-4 door)",multiplier:1},{size:"SUV (5-door)",multiplier:1.2},{size:"XXL",multiplier:1.5}],ZIP_WHITE_LIST=["22314","22301","22305","22302","22304","22202","22206","22311","22312","22204","22041","22211","22201","22203","22209","22044","22151","22150","22152","22153","22015","22205","22042","22046","22003","22207","22213","22031","22043","22027","22101","22182","22030","22032","22039","20124"],Constants=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"TIRE_SHINE_DETAILS",get:function(){return TIRE_SHINE_DETAILS}},{key:"INTERIOR_DETAILS",get:function(){return INTERIOR_DETAILS}},{key:"WAX_DETAILS",get:function(){return WAX_DETAILS}},{key:"WASH_DETAILS",get:function(){return WASH_DETAILS}},{key:"ZIP_WHITE_LIST",get:function(){return ZIP_WHITE_LIST}},{key:"MORNING_TIME_RANGE",get:function(){return MORNING_TIME_RANGE}},{key:"AFTERNOON_TIME_RANGE",get:function(){return AFTERNOON_TIME_RANGE}},{key:"EVENING_TIME_RANGE",get:function(){return EVENING_TIME_RANGE}},{key:"NIGHT_TIME_RANGE",get:function(){return NIGHT_TIME_RANGE}},{key:"CAR_SIZES",get:function(){return CAR_SIZES}},{key:"ORDER_SUCCESS_MSG",get:function(){return ORDER_SUCCESS_MSG}},{key:"ORDER_FAILURE_MSG",get:function(){return ORDER_FAILURE_MSG}},{key:"BAD_ZIP_MSG",get:function(){return BAD_ZIP_MSG}},{key:"ASYNC_INTERUPTION_MARKER",get:function(){return ASYNC_INTERUPTION_MARKER}},{key:"MAX_JOB_TIME_PER_INTERVAL",get:function(){return MAX_JOB_TIME_PER_INTERVAL}}]),e}()
...
this.carYear=ko.observable(this.carYears[1]),this.first=ko.observable(""),this.last=ko.observable(""),this.email=ko.observable(""),this.phone=ko.observable(""),this.showAddLocationForm=ko.observable(!1),this.locations=ko.observableArray([]),this.locationTitleOptions=["Home","Work","Other"],this.title=ko.observable(this.locationTitleOptions[0]),this.street=ko.observable(""),this.city=ko.observable(""),this.state=ko.observable(""),this.zip=ko.observable(this.storageHelper.ZipCode),this.orderTotal=ko.computed(function(){var e=0,t=parseFloat(a.WASH_COST+(a.addShine()?a.TIRE_SHINE_COST:0)+(a.addWax()?a.WAX_COST:0)+(a.addInterior()?a.INTERIOR_COST:0))
return a.cars().forEach(function(i){if(i.selected()){var a=_.find(Constants.CAR_SIZES,function(e){return e.size==i.size||e.multiplier==i.multiplier})
a&&(e+=t*a.multiplier)}}),10>e?e.toPrecision(3):e>=100?e.toPrecision(5):e.toPrecision(4)}),this.orderSummary=ko.computed(function(){var e=""
return a.cars().forEach(function(t){if(t.selected()){var i=_.find(Constants.CAR_SIZES,function(e){return e.size==t.size||e.multiplier==t.multiplier})
e+=$.validator.format("<strong>{5} {6}</strong><br>Exterior Hand Wash<br>{0}{1}{2}{3} = {4}x cost multiplier.<br>",a.addShine()?"Deep Tire Clean & Shine<br>":"",a.addWax()?"Hand Wax & Buff<br>":"",a.addInterior()?"Full Interior Cleaning<br>":"",i.size,i.multiplier.toString(),t.make,t.model)}}),e})}return _createClass(e,[{key:"OnAfterRender",value:function(e,t){t.$addVehicleForm=$("#add-vehicle-form"),t.$addLocationForm=$("#add-location-form"),t.$orderDetailsForm=$("#order-details-form"),$("#phone").mask("(999) 999-9999? ext:99999",{placeholder:" "}),$("#datetimepicker").datetimepicker({minDate:new Date,format:"MM/DD/YY"}).on("dp.change",t._onDatepickerChange.bind(t)),t._initValidation()}},{key:"OnAddNewLocation",value:function(){this.showAddLocationForm(!0)}},{key:"OnCancelNewLocation",value:function(){this.$addVehicleForm.find("input").val(""),this.$addLocationForm.validate().resetForm(),this.showAddLocationForm(!1)}},{key:"OnSaveNewLocation",value:function(){if(this.$addLocationForm.valid()){var e=this._makeLocationSchema()
...
async.series([this._verifyUser.bind(this),this._executeCharge.bind(this,e),this._updateUserData.bind(this),this._sendEmailConfirmation.bind(this)],function(e){e?t._onOrderFailure(e):t._onOrderSuccess()})}catch(i){this._onOrderFailure(i)}}},{key:"_onOrderFailure",value:function(e){bootbox.alert(Constants.ORDER_FAILURE_MSG),console.log(e)}},{key:"_onOrderSuccess",value:function(){bootbox.alert(Constants.ORDER_SUCCESS_MSG),this.OnFormCancel()}},{key:"_sendEmailConfirmation",value:function(e){this.webSvc.SendConfirmationEmail(this.storageHelper.LoggedInUser.email,this.storageHelper.LoggedInUser.appointments).then(function(){return e()}).fail(function(t){return e(t)})}},{key:"_verifyUser",value:function(e){var t=this
...
else{var a=t._makeTempUserSchema()
t.storageHelper.LoggedInUser=i,t.webSvc.CreateUser(a).then(function(){return e()}).fail(function(t){return e(t)})}}).fail(function(t){return e(t)})}},{key:"_executeCharge",value:function(e,t){this.webSvc.ExecuteCharge(e,100*this.orderTotal(),this.last()).then(function(){return t()}).fail(function(e){return t(e)})}},{key:"_updateUserData",value:function(e){var t=this.storageHelper.LoggedInUser,i=this._makeAppointmentSchema()
t.appointments?t.appointments.push(i):t.appointments=[i],t.cars=this.cars(),t.phone=this.phone(),t.locations=this.locations(),t.firstName=this.first(),t.lastName=this.last(),this.webSvc.UpdateUser(t).then(function(){return e()}).fail(function(t){return e(t)})}},{key:"_prePopulateUserData",value:function(){var e=this.storageHelper.LoggedInUser
...
if(i){var a=Constants.MAX_JOB_TIME_PER_INTERVAL,o=_.filter(i,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),r=_.filter(i,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),n=_.filter(i,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),s=_.filter(i,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
Constants.MORNING_TIME_RANGE.disabled(_.reduce(o,function(e,t){return e+t.timeEstimate},0)>a),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(r,function(e,t){return e+t.timeEstimate},0)>a),Constants.EVENING_TIME_RANGE.disabled(_.reduce(n,function(e,t){return e+t.timeEstimate},0)>a),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(s,function(e,t){return e+t.timeEstimate},0)>a)}}},{key:"_initValidation",value:function(){this.$orderDetailsForm.validate({rules:{first:"required",last:"required",email:{required:!0,email:!0},phone:"required"},messages:{email:"Please enter a valid email address."}}),this.$addVehicleForm.validate({rules:{make:"required",model:"required",color:"required"}}),this.$addLocationForm.validate({rules:{street:"required",city:"required",state:"required",zip:"required"}})}},{key:"_makeTempUserSchema",value:function(){return{appointments:[this._makeAppointmentSchema()],cars:this.cars(),email:this.email(),phone:this.phone(),firstName:this.first(),lastName:this.last(),pwd:Utils.GenerateUUID(),locations:this.locations()}}},{key:"_makeCarSchema",value:function(){return{color:this.color(),make:this.make(),model:this.model(),size:this.selectedCarSize().size,tag:this.tag(),year:parseInt(this.carYear()),selected:ko.observable(!1)}}},{key:"_makeAppointmentSchema",value:function(){return{cars:[this._makeCarSchema()],date:new Date(this.date()),location:this._makeLocationSchema(),price:this.orderTotal(),services:this._buildServicesArray(),timeEstimate:this._getTimeEstimate(),timeRange:this.selectedTimeRange().range,timeRangeEnum:this.selectedTimeRange().key,description:this.description()}}},{key:"_makeLocationSchema",value:function(){return{city:this.city(),state:this.state(),street:this.street(),title:this.title(),zip:this.zip(),selected:ko.observable(!1)}}},{key:"_getTimeEstimate",value:function(){var e=Constants.WASH_DETAILS.time
