...
e.css("display","block"),t.css("margin-top",Math.max(0,($(window).height()-t.height())/2))}var t=this,i=$.Deferred(),n=null
spinner=new LoadingSpinner,$(".navbar-collapse ul li a").click(function(){$(".navbar-toggle:visible").click()}),$("body").scrollspy({target:".navbar-fixed-top"}),$(".modal").on("show.bs.modal",e),$(window).on("resize",function(){$(".modal:visible").each(e)}),navigator.userAgent.match(/iPhone|iPad|iPod/i)&&$(".modal").on("show.bs.modal",function(){$(t).css({position:"absolute",marginTop:$(window).scrollTop()+"px",bottom:"auto"}),setTimeout(function(){$(".modal-backdrop").css({position:"absolute",top:0,left:0,width:"100%",height:Math.max(document.body.scrollHeight,document.documentElement.scrollHeight,document.body.offsetHeight,document.documentElement.offsetHeight,document.body.clientHeight,document.documentElement.clientHeight)+"px"})},0)})
var r="Application failed to initialize."
return async.series([function(e){$("#order-form-tmpl").load("./templates/order-form-tmpl.html",function(t,i,n){"error"===i?e(r):e()})},function(e){$("#vehicle-tmpl").load("./templates/vehicle-tmpl.html",function(t,i,n){"error"===i?e(r):e()})},function(e){$("#location-tmpl").load("./templates/location-tmpl.html",function(t,i,n){"error"===i?e(r):e()})},function(e){n=new WebService,n.GetEnvironment().then(function(t){environment=t,e()}).fail(function(t){return e(t)})},function(e){var t=new LocalStorageHelper(sessionStorage),i=new OrderFormViewModel(t,n),r=new LogInViewModel(t,n),o=new MainViewModel(t,r,i)
ko.applyBindings(o),n.GetFutureAppointments().then(function(i){var n=_.groupBy(i,function(e){return moment(e.date).format("MM/DD/YYYY")})
t.AppointmentsByDate=n,e()}).fail(function(t){e(t)})}],function(e){e?i.reject(e):i.resolve()}),i.promise()}}]),e}(),cbpAnimatedHeader=function(){function e(){window.addEventListener("scroll",function(e){o||(o=!0,setTimeout(t,250))},!1)}function t(){var e=i()
