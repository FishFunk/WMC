...
this.carYear=ko.observable(this.carYears[1]),this.first=ko.observable(""),this.last=ko.observable(""),this.email=ko.observable(""),this.phone=ko.observable(""),this.showAddLocationForm=ko.observable(!1),this.locations=ko.observableArray([]),this.locationTitleOptions=["Home","Work","Other"],this.title=ko.observable(this.locationTitleOptions[0]),this.street=ko.observable(""),this.city=ko.observable(""),this.state=ko.observable(""),this.zip=ko.observable(this.storageHelper.ZipCode),this.hideSubscriptionForm=ko.observable(!0),this.subIntervals=[1,2,3],this.selectedSubInterval=ko.observable(this.subIntervals[0]),this.subSpans=[{days:7,display:"Week(s)"},{days:28,display:"Month(s)"}],this.selectedSubSpan=ko.observable(this.subSpans[0]),this.couponCode=ko.observable(""),this.coupon=ko.observable(null),this.orderTotal=ko.computed(function(){var e=0,t=parseFloat(n.WASH_COST+(n.addShine()?n.TIRE_SHINE_COST:0)+(n.addWax()?n.WAX_COST:0)+(n.addInterior()?n.INTERIOR_COST:0))
