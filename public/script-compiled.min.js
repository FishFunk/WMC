...
var t=moment().hour(),i=moment().format(Configuration.DATE_FORMAT),n=moment().add(1,"day").format(Configuration.DATE_FORMAT),o=e.format(Configuration.DATE_FORMAT),r=e.day(),s=_.find(Configuration.SCHEDULE,function(e){return e.day===r}),a=this.storageHelper.AppointmentsByDate[o]||[],l=Configuration.MAX_JOB_TIME_PER_INTERVAL,c=_.filter(a,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),u=_.filter(a,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),d=_.filter(a,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),h=_.filter(a,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
Constants.MORNING_TIME_RANGE.disabled(_.reduce(c,function(e,t){return e+t.timeEstimate},0)>=l||o==i&&t>=1||o==n&&t>=20||_.contains(s.blockedTimeSlots,Constants.MORNING_TIME_RANGE.key)),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(u,function(e,t){return e+t.timeEstimate},0)>=l||o==i&&t>=9||o==n&&t>=20||_.contains(s.blockedTimeSlots,Constants.AFTERNOON_TIME_RANGE.key)),Constants.EVENING_TIME_RANGE.disabled(_.reduce(d,function(e,t){return e+t.timeEstimate},0)>=l||o==i&&t>=12||_.contains(s.blockedTimeSlots,Constants.EVENING_TIME_RANGE.key)),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(h,function(e,t){return e+t.timeEstimate},0)>=l||o==i&&t>=15||_.contains(s.blockedTimeSlots,Constants.NIGHT_TIME_RANGE.key)),this.selectedTimeRange().disabled()&&this.selectedTimeRange(Constants.TIME_RANGE_PLACE_HOLDER)}},{key:"_initValidation",value:function(){var e=this
