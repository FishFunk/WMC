...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),ASYNC_INTERUPTION_MARKER="ASYNC_INTERUPTION_MARKER",CHARGE_FAILURE_MARKER="CARD_CHARGE_FAILURE",MORNING_TIME_RANGE={range:"9:00 - 12:00 PM",key:1,disabled:ko.observable(!1)},AFTERNOON_TIME_RANGE={range:"12:00 - 3:00 PM",key:2,disabled:ko.observable(!1)},EVENING_TIME_RANGE={range:"3:00 - 6:00 PM",key:3,disabled:ko.observable(!1)},NIGHT_TIME_RANGE={range:"6:00 - 9:00 PM",key:4,disabled:ko.observable(!1)},Constants=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"MORNING_TIME_RANGE",get:function(){return MORNING_TIME_RANGE}},{key:"AFTERNOON_TIME_RANGE",get:function(){return AFTERNOON_TIME_RANGE}},{key:"EVENING_TIME_RANGE",get:function(){return EVENING_TIME_RANGE}},{key:"NIGHT_TIME_RANGE",get:function(){return NIGHT_TIME_RANGE}}]),e}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
...
return n.coupon()&&(t=100==n.coupon().discountPercentage?"First Timer Discount - First Wash Free!":"Promo discount: "+n.couponCode().discountPercentage.toString()+"%"),n.cars().forEach(function(i){if(i.selected()){var o=_.find(Configuration.CAR_SIZES,function(e){return e.size==i.size||e.multiplier==i.multiplier})
