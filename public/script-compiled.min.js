...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),GiftFormViewModel=function(){function e(t,i){_classCallCheck(this,e)
var n=this
this.stripeHandler=StripeCheckout.configure({key:Configuration.StripeKey,image:"/img/square_logo.png",locale:"auto",token:this._completeOrder.bind(this)}),$(window).on("popstate",function(){n.stripeHandler.close()}),this.storageHelper=t,this.webSvc=i,this.$giftFormModal=$("#gift-form-modal"),this.TIRE_SHINE_COST=Configuration.TIRE_SHINE_DETAILS.price,this.INTERIOR_COST=Configuration.INTERIOR_DETAILS.price,this.WAX_COST=Configuration.WAX_DETAILS.price,this.WASH_COST=Configuration.WASH_DETAILS.price,this.TIRE_SHINE_TITLE=Configuration.TIRE_SHINE_DETAILS.title,this.INTERIOR_TITLE=Configuration.INTERIOR_DETAILS.title,this.WAX_TITLE=Configuration.WAX_DETAILS.title,this.WASH_TITLE=Configuration.WASH_DETAILS.title,this.incompleteGiftMsg=ko.observable(""),this.addWash=ko.observable(!0),this.addShine=ko.observable(!1),this.addWax=ko.observable(!1),this.addInterior=ko.observable(!1),this.carSizes=Configuration.CAR_SIZES,this.selectedCarSize=ko.observable(this.carSizes[0]),this.email=ko.observable(""),this.zip=ko.observable(this.storageHelper.ZipCode),this.orderTotal=ko.computed(function(){var e=0,t=(n.addWash()?n.WASH_COST:0)+(n.addShine()&&n.addWash()?n.TIRE_SHINE_COST:0)+(n.addWax()&&n.addWash()?n.WAX_COST:0)+(n.addInterior()?n.INTERIOR_COST:0)
return e+=n.selectedCarSize().multiplier*t,e.toFixed(2)}),this.orderSummary=ko.computed(function(){var e=""
return e+=n._buildServicesSummary()+"<hr>",e+=$.validator.format("<strong>{0}</strong>{1}<br>",n.selectedCarSize().size,n.selectedCarSize().multiplier>1?" - additional "+Math.round(100*(n.selectedCarSize().multiplier-1)).toString()+"%":"")})}return _createClass(e,[{key:"OnAfterRender",value:function(e,t){t.$giftForm=$("#gift-form"),t._initValidation()}},{key:"OnSubmit",value:function(){return this.addWash()||this.addInterior()?this.$giftForm.valid()?Utils.VerifyZip(this.zip())?($("#incomplete-gift-alert").hide(),void this._openCheckout()):(this.incompleteGiftMsg("Sorry but we currently don't service within that zip code."),void $("#incomplete-gift-alert").show()):(this.incompleteGiftMsg("Please fill in required details."),void $("#incomplete-gift-alert").show()):(this.incompleteGiftMsg("Interior and/or exterior cleaning must be selected."),void $("#incomplete-gift-alert").show())}},{key:"OnFormCancel",value:function(){try{$("#incomplete-gift-alert").hide(),this.$giftFormModal.modal("hide"),this.$giftForm.validate().resetForm(),this._resetObservables(),window.location="#page-top"}catch(e){console.log("Failed to reset fields OnFormCancel()"),console.log(e)}}},{key:"_openCheckout",value:function(){this.stripeHandler.open({key:Configuration.StripeKey,name:"WMC Checkout",amount:100*this.orderTotal(),zipCode:!0,email:this.email()})}},{key:"_completeOrder",value:function(e){try{var t=this
...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),MainViewModel=function(){function e(t,i,n,o){_classCallCheck(this,e),this.WASH_COST=Configuration.WASH_DETAILS.price,this.WashPriceHtml="<sup>$</sup>"+this.WASH_COST,this.TireShinePriceHtml="<sup>$</sup>"+Configuration.TIRE_SHINE_DETAILS.price,this.InteriorPriceHtml="<sup>$</sup>"+Configuration.INTERIOR_DETAILS.price,this.WaxPriceHtml="<sup>$</sup>"+Configuration.WAX_DETAILS.price,this.WASH_TITLE=Configuration.WASH_DETAILS.title,this.TIRE_SHINE_TITLE=Configuration.TIRE_SHINE_DETAILS.title,this.WAX_TITLE=Configuration.WAX_DETAILS.title,this.INTERIOR_TITLE=Configuration.INTERIOR_DETAILS.title,this.LogInViewModel=i,this.OrderFormViewModel=n,this.GiftFormViewModel=o,this.storageHelper=t,this.zip=ko.observable(""),this.storageHelper.ZipCode?this.zipVerified=ko.observable(!0):this.zipVerified=ko.observable(!1)}return _createClass(e,[{key:"DialogPresenter",get:function(){return dialogPresenter}}]),_createClass(e,[{key:"OnPageScroll",value:function(e,t){var i=$(t.currentTarget)
...
e+=o.multiplier*t}),e.toFixed(2)}),this.discountedTotal=ko.computed(function(){var e=n.orderTotal()
if(!n.coupon())return e
var t=n.coupon().amount
return t>e?e=0:e-=t,e.toFixed(2)}),this.discountRemaining=ko.computed(function(){if(!n.coupon())return 0
var e=n.coupon().amount,t=e-n.orderTotal()
...
return t.length>0&&(e+=n._buildServicesSummary()+"<hr>"),t.forEach(function(t){var i=_.find(Configuration.CAR_SIZES,function(e){return e.size==t.size||e.multiplier==t.multiplier})
