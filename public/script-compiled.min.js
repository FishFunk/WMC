...
t.LoggedInUser
this.TIRE_SHINE_COST=Constants.TIRE_SHINE_DETAILS.price,this.INTERIOR_COST=Constants.INTERIOR_DETAILS.price,this.WAX_COST=Constants.WAX_DETAILS.price,this.WASH_COST=Constants.WASH_DETAILS.price,this.disableEmailInput=ko.observable(!1),this.incompleteFormMsg=ko.observable(""),this.addShine=ko.observable(!1),this.addWax=ko.observable(!1),this.addInterior=ko.observable(!1),this.showBillingAddress=ko.observable(!1),this.description=ko.observable(""),this.timeRangeOptions=[Constants.MORNING_TIME_RANGE,Constants.AFTERNOON_TIME_RANGE,Constants.EVENING_TIME_RANGE,Constants.NIGHT_TIME_RANGE],this.selectedTimeRange=ko.observable(this.timeRangeOptions[0]),this.date=ko.observable(""),this.showAddVehicleForm=ko.observable(!1),this.cars=ko.observableArray([]),this.make=ko.observable(""),this.model=ko.observable(""),this.color=ko.observable(""),this.tag=ko.observable(""),this.carSizes=Constants.CAR_SIZES,this.selectedCarSize=ko.observable(this.carSizes[0]),this.carYears=[]
...
_.each(t,function(e){return e.selected=ko.observable(!1)}),_.each(i,function(e){return e.selected=ko.observable(!1)}),this.locations(t),this.cars(i),this.email(e.email||""),this.phone(e.phone||""),this.first(e.firstName||""),this.last(e.lastName||""),e.email&&this.disableEmailInput(!0),$("#phone").trigger("input")}}},{key:"_onDatepickerChange",value:function(e){e&&this._updatePickerAndTimerangeOptions(e.date)}},{key:"_updatePickerAndTimerangeOptions",value:function(e){var t=moment().hour(),i=moment().format(Constants.DATE_FORMAT),n=e.format(Constants.DATE_FORMAT)
this.date(e.format("ddd MMM Do"))
var r=this.storageHelper.AppointmentsByDate[n]||[],o=Constants.MAX_JOB_TIME_PER_INTERVAL,a=_.filter(r,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),s=_.filter(r,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),l=_.filter(r,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),c=_.filter(r,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
