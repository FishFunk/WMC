...
ko.applyBindings(r),i.GetFutureAppointments().then(function(i){var n=_.groupBy(i,function(e){return moment(e.date).format(Constants.DATE_FORMAT)})
...
e>=s?classie.add(o,"navbar-shrink"):classie.remove(o,"navbar-shrink"),r=!1}function i(){return window.pageYOffset||n.scrollTop}var n=document.documentElement,o=document.querySelector(".navbar-default"),r=!1,s=300
e()}()
...
"function"==typeof define&&define.amd?define(s):e.classie=s}(window)
...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),ASYNC_INTERUPTION_MARKER="ASYNC_INTERUPTION_MARKER",CHARGE_FAILURE_MARKER="CARD_CHARGE_FAILURE",MORNING_TIME_RANGE={range:"9:00 AM - 12:00 PM",key:1,disabled:ko.observable(!1)},AFTERNOON_TIME_RANGE={range:"12:00 - 3:00 PM",key:2,disabled:ko.observable(!1)},EVENING_TIME_RANGE={range:"3:00 - 6:00 PM",key:3,disabled:ko.observable(!1)},NIGHT_TIME_RANGE={range:"6:00 - 9:00 PM",key:4,disabled:ko.observable(!1)},Constants=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"MORNING_TIME_RANGE",get:function(){return MORNING_TIME_RANGE}},{key:"AFTERNOON_TIME_RANGE",get:function(){return AFTERNOON_TIME_RANGE}},{key:"EVENING_TIME_RANGE",get:function(){return EVENING_TIME_RANGE}},{key:"NIGHT_TIME_RANGE",get:function(){return NIGHT_TIME_RANGE}},{key:"ASYNC_INTERUPTION_MARKER",get:function(){return ASYNC_INTERUPTION_MARKER}},{key:"CHARGE_FAILURE_MARKER",get:function(){return CHARGE_FAILURE_MARKER}}]),e}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
...
var o=this
this.stripeHandler=StripeCheckout.configure({key:"production"==environment?"pk_live_aULtlGy6YPvc94K5Hjvqwokg":"pk_test_luqEThs0vblV173fgAHgPZBG",image:"/img/square_logo.png",locale:"auto",token:this._completeOrder.bind(this)}),$(window).on("popstate",function(){o.stripeHandler.close()}),this.webSvc=i,this.storageHelper=t,this.$orderFormModal=$("#order-form-modal"),this.$orderFormModal.on("show.bs.modal",function(){o._prePopulateUserData()}),this.TIRE_SHINE_COST=Configuration.TIRE_SHINE_DETAILS.price,this.INTERIOR_COST=Configuration.INTERIOR_DETAILS.price,this.WAX_COST=Configuration.WAX_DETAILS.price,this.WASH_COST=Configuration.WASH_DETAILS.price,this.disableEmailInput=ko.observable(!1),this.incompleteFormMsg=ko.observable(""),this.showNewUserAlert=ko.observable(!1),this.addShine=ko.observable(!1),this.addWax=ko.observable(!1),this.addInterior=ko.observable(!1),this.showBillingAddress=ko.observable(!1),this.description=ko.observable(""),this.timeRangeOptions=[Constants.MORNING_TIME_RANGE,Constants.AFTERNOON_TIME_RANGE,Constants.EVENING_TIME_RANGE,Constants.NIGHT_TIME_RANGE],this.selectedTimeRange=ko.observable(this.timeRangeOptions[0]),this.dateMoment=null,this.showAddVehicleForm=ko.observable(!1),this.cars=ko.observableArray([]),this.make=ko.observable(""),this.model=ko.observable(""),this.color=ko.observable(""),this.tag=ko.observable(""),this.carSizes=Configuration.CAR_SIZES,this.selectedCarSize=ko.observable(this.carSizes[0]),this.carYears=[]
for(var r=(new Date).getFullYear()+1,s=0;25>s;s++)this.carYears.push((r-s).toString())
this.carYear=ko.observable(this.carYears[1]),this.first=ko.observable(""),this.last=ko.observable(""),this.email=ko.observable(""),this.phone=ko.observable(""),this.showAddLocationForm=ko.observable(!1),this.locations=ko.observableArray([]),this.locationTitleOptions=["Home","Work","Other"],this.title=ko.observable(this.locationTitleOptions[0]),this.street=ko.observable(""),this.city=ko.observable(""),this.state=ko.observable(""),this.zip=ko.observable(this.storageHelper.ZipCode),this.hideSubscriptionForm=ko.observable(!0),this.subIntervals=[1,2,3],this.selectedSubInterval=ko.observable(this.subIntervals[0]),this.subSpans=[{days:7,display:"Week(s)"},{days:28,display:"Month(s)"}],this.selectedSubSpan=ko.observable(this.subSpans[0]),this.couponCode=ko.observable(""),this.coupon=ko.observable(null),this.orderTotal=ko.computed(function(){var e=0,t=parseFloat(o.WASH_COST+(o.addShine()?o.TIRE_SHINE_COST:0)+(o.addWax()?o.WAX_COST:0)+(o.addInterior()?o.INTERIOR_COST:0))
return o.cars().forEach(function(i){if(i.selected()){var n=_.find(Configuration.CAR_SIZES,function(e){return e.size==i.size||e.multiplier==i.multiplier})
n&&(e+=t*n.multiplier)}}),Math.floor(e)}),this.discountedTotal=ko.computed(function(){var e=o.orderTotal()
if(!o.coupon())return e
if(100==o.coupon().discountPercentage)return e-=n.WASH_COST
var t=o.coupon().discountPercentage/100
return e-e*t}),this.orderSummary=ko.computed(function(){var e="",t=""
return o.hideSubscriptionForm()?o.dateMoment&&(t=$.validator.format("<strong>{0} {1}</strong><hr>",o.dateMoment.format("ddd MMM Do"),o.selectedTimeRange().range)):o.dateMoment&&(t=$.validator.format("<strong>{0} every {1} {2} starting {3}</strong><hr>",o.selectedTimeRange().range,o.selectedSubInterval(),o.selectedSubSpan().display,o.dateMoment.format("ddd MMM Do"))),o.coupon()&&(e=100==o.coupon().discountPercentage?"Wow! A free wash! Now that's a sweet deal!":"Promo discount: "+o.coupon().discountPercentage.toString()+"%"),o.cars().forEach(function(e){if(e.selected()){var i=_.find(Configuration.CAR_SIZES,function(t){return t.size==e.size||t.multiplier==e.multiplier})
t+=$.validator.format("<strong>{5} {6}</strong><br>Exterior Hand Wash<br>{0}{1}{2}{3}{4}<br>",o.addShine()?"Deep Tire Clean & Shine<br>":"",o.addWax()?"Hand Wax & Buff<br>":"",o.addInterior()?"Full Interior Cleaning<br>":"",i.size,i.multiplier>1?" - additional "+Math.round(100*(i.multiplier-1)).toString()+"%":"",e.make,e.model)}}),t+=e})}return _createClass(e,[{key:"OnAfterRender",value:function(e,t){t.$addVehicleForm=$("#add-vehicle-form"),t.$addLocationForm=$("#add-location-form"),t.$contactDetailsForm=$("#contact-details-form"),t.$orderDetailsForm=$("#order-details-form"),$("#phone").mask("(999) 999-9999? ext:99999",{placeholder:" "}),$("#datetimepicker").datetimepicker({minDate:moment().subtract(1,"days"),maxDate:moment().add(60,"days"),format:Configuration.DATE_FORMAT,allowInputToggle:!0,focusOnShow:!1,ignoreReadonly:!0}).on("dp.change",t._onDatepickerChange.bind(t)),t._initValidation()}},{key:"OnAddNewLocation",value:function(){this.showAddLocationForm(!0)}},{key:"OnCancelNewLocation",value:function(){this.$addVehicleForm.find("input").val(""),this.$addLocationForm.validate().resetForm(),this.showAddLocationForm(!1)}},{key:"OnSaveNewLocation",value:function(){if(this.$addLocationForm.valid()){var e=this._makeLocationSchema()
...
e.selected(!0),this.cars.push(e),this.$addVehicleForm.find("input").val(""),this.showAddVehicleForm(!1)}}},{key:"OnClickVehiclePanel",value:function(e,t){t.selected(!t.selected())}},{key:"OnDeleteVehiclePanel",value:function(e,t){e.cars(_.reject(e.cars(),function(e){return _.isEqual(e,t)}))}},{key:"OnClickLocationPanel",value:function(e,t){_.each(e.locations(),function(e){e.selected(!1)}),t.selected(!0)}},{key:"OnDeleteLocationPanel",value:function(e,t){e.locations(_.reject(e.locations(),function(e){return _.isEqual(e,t)}))}},{key:"OnSubmit",value:function(e){if(!this.$orderDetailsForm.valid())return this.incompleteFormMsg("Please select a date of service."),void $("#incomplete-form-alert").show()
...
if(!this.locations()||0===this.locations().length)return void this.incompleteFormMsg("Please add a location.")
...
_.each(t,function(e){return e.selected=ko.observable(!1)}),_.each(i,function(e){return e.selected=ko.observable(!1)}),this.locations(t),this.cars(i),this.email(e.email||""),this.phone(e.phone||""),this.first(e.firstName||""),this.last(e.lastName||""),e.email&&this.disableEmailInput(!0),$("#phone").trigger("input")}this.showNewUserAlert(this.storageHelper.IsNewUser)}},{key:"_resetObservables",value:function(){this.showNewUserAlert(!1),this.disableEmailInput(!1),this.incompleteFormMsg(""),this.addShine(!1),this.addWax(!1),this.addInterior(!1),this.showBillingAddress(!1),this.description=ko.observable(""),this.selectedTimeRange(this.timeRangeOptions[0]),$("#datetimepicker").data("DateTimePicker").clear(),this.showAddVehicleForm(!1),this.cars([]),this.make(""),this.model(""),this.color(""),this.tag(""),this.selectedCarSize(this.carSizes[0]),this.carYear(this.carYears[1]),this.first(""),this.last(""),this.email(""),this.phone(""),this.showAddLocationForm(!1),this.locations([]),this.title(this.locationTitleOptions[0]),this.street(""),this.city(""),this.state(""),this.zip(""),this.couponCode(""),this.coupon(null)}},{key:"_onDatepickerChange",value:function(e){e&&(this.dateMoment=e.date,this._updatePickerAndTimerangeOptions(e.date))}},{key:"_updatePickerAndTimerangeOptions",value:function(e){var t=moment().hour(),i=moment().format(Configuration.DATE_FORMAT),n=e.format(Configuration.DATE_FORMAT),o=this.storageHelper.AppointmentsByDate[n]||[],r=Configuration.MAX_JOB_TIME_PER_INTERVAL,s=_.filter(o,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),a=_.filter(o,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),l=_.filter(o,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),c=_.filter(o,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
Constants.MORNING_TIME_RANGE.disabled(_.reduce(s,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=11),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(a,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=14),Constants.EVENING_TIME_RANGE.disabled(_.reduce(l,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=17),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(c,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=20)
for(var u=0;u<this.timeRangeOptions.length;u++){var h=this.timeRangeOptions[u]
if(!h.disabled()){this.selectedTimeRange(h)
break}}}},{key:"_initValidation",value:function(){this.$orderDetailsForm.validate({rules:{date:"required"},errorPlacement:function(){}}),this.$contactDetailsForm.validate({rules:{first:"required",last:"required",date:"required",email:{required:!0,email:!0},phone:"required"},messages:{email:"Please enter a valid email address."}}),this.$addVehicleForm.validate({rules:{make:"required",model:"required",color:"required"}}),this.$addLocationForm.validate({rules:{street:"required",city:"required",state:"required",zip:"required"}})}},{key:"_makeGuestUserSchema",value:function(){return{isGuest:!0,email:this.email(),pwd:Utils.GenerateUUID()}}},{key:"_makeCarSchema",value:function(){return{color:this.color(),make:this.make(),model:this.model(),size:this.selectedCarSize().size,tag:this.tag(),year:parseInt(this.carYear()),selected:ko.observable(!1)}}},{key:"_makeAppointmentSchema",value:function(e){var t=_.filter(this.cars(),function(e){return e.selected()}),i=_.find(this.locations(),function(e){return e.selected()})
return{cars:t,date:this.dateMoment.toDate(),location:i,prepaid:e,price:this.discountedTotal(),services:this._buildServicesArray(),timeEstimate:this._getTimeEstimate(),timeRange:this.selectedTimeRange().range,timeRangeKey:this.selectedTimeRange().key,description:this.description()}}},{key:"_makeSubscriptionSchema",value:function(e){for(var t=_.filter(this.cars(),function(e){return e.selected()}),i=_.find(this.locations(),function(e){return e.selected()}),n=this.selectedSubInterval()*this.selectedSubSpan().days,o=Math.round(365/n),r=n,s=[],a=0;o>a;a++){var l=new Date(e)
l.setDate(e.getDate()+r),s.push(l),r+=n}return{cars:t,dates:s,location:i,price:this.orderTotal(),services:this._buildServicesArray(),timeEstimate:this._getTimeEstimate(),timeRange:this.selectedTimeRange().range,timeRangeKey:this.selectedTimeRange().key,description:this.description()}}},{key:"_makeLocationSchema",value:function(){return{city:this.city(),state:this.state(),street:this.street(),title:this.title(),zip:this.zip(),selected:ko.observable(!1)}}},{key:"_getTimeEstimate",value:function(){var e=Configuration.WASH_DETAILS.time
return this.addShine()&&(e+=Configuration.TIRE_SHINE_DETAILS.time),this.addWax()&&(e+=Configuration.WAX_DETAILS.time),this.addInterior()&&(e+=Configuration.INTERIOR_DETAILS.time),e}},{key:"_buildServicesArray",value:function(){var e=[Configuration.WASH_DETAILS.title]
return this.addShine()&&e.push(Configuration.TIRE_SHINE_DETAILS.title),this.addWax()&&e.push(Configuration.WAX_DETAILS.title),this.addInterior()&&e.push(Configuration.INTERIOR_DETAILS.title),e}}]),e}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
