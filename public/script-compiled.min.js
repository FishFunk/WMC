...
var o=this
this.stripeHandler=StripeCheckout.configure({key:Configuration.StripeKey,image:"/img/square_logo.png",locale:"auto",token:this._completeOrder.bind(this)}),$(window).on("popstate",function(){o.stripeHandler.close()}),this.storageHelper=t,this.webSvc=i,this.$giftFormModal=$("#gift-form-modal"),this.incompleteGiftMsg=ko.observable(""),this.Services=ko.observableArray(Configuration.SERVICES),this.addWash=ko.computed(function(){return _.find(n.Services(),function(e){return e.item==Constants.WASH}).checked()}),this.addInterior=ko.computed(function(){return _.find(n.Services(),function(e){return e.item==Constants.INTERIOR}).checked()}),this.addWash.subscribe(function(e){n.Services().forEach(function(t){t.item!=Constants.INTERIOR&&t.item!=Constants.WASH&&t.disable(!e)})}),this.Rows=_.partition(this.Services(),function(e){return e.sortOrder<=Math.ceil(n.Services().length/2)}),this.carSizes=Configuration.CAR_SIZES,this.selectedCarSize=ko.observable(this.carSizes[0]),this.email=ko.observable(""),this.zip=ko.observable(this.storageHelper.ZipCode),this.orderTotal=ko.computed(function(){var e=0,t=_.reduce(n.Services(),function(e,t){return t.checked()&&(e+=t.price),e},0)
...
return this.Services().forEach(function(t){t.checked()&&(e+=t.title+"<br>")}),e}}]),e}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
...
o.hideSubscriptionForm()?o.dateMoment&&(e=$.validator.format("<strong>{0} {1}</strong><br>",o.dateMoment.format("ddd MMM Do"),o.selectedTimeRange().range)):o.dateMoment&&(e=$.validator.format("<strong>{0} every {1} {2} starting {3}</strong><hr>",o.selectedTimeRange().range,o.selectedSubInterval(),o.selectedSubSpan().display,o.dateMoment.format("ddd MMM Do")))
...
var t=moment().hour(),i=moment().format(Configuration.DATE_FORMAT),n=e.format(Configuration.DATE_FORMAT),o=e.day(),r=_.find(Configuration.SCHEDULE,function(e){return e.day===o}),s=this.storageHelper.AppointmentsByDate[n]||[],a=Configuration.MAX_JOB_TIME_PER_INTERVAL,l=_.filter(s,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),c=_.filter(s,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),u=_.filter(s,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),h=_.filter(s,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
Constants.MORNING_TIME_RANGE.disabled(_.reduce(l,function(e,t){return e+t.timeEstimate},0)>a||n==i&&t>=9||_.contains(r.blockedTimeSlots,Constants.MORNING_TIME_RANGE.key)),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(c,function(e,t){return e+t.timeEstimate},0)>a||n==i&&t>=12||_.contains(r.blockedTimeSlots,Constants.AFTERNOON_TIME_RANGE.key)),Constants.EVENING_TIME_RANGE.disabled(_.reduce(u,function(e,t){return e+t.timeEstimate},0)>a||n==i&&t>=15||_.contains(r.blockedTimeSlots,Constants.EVENING_TIME_RANGE.key)),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(h,function(e,t){return e+t.timeEstimate},0)>a||n==i&&t>=18||_.contains(r.blockedTimeSlots,Constants.NIGHT_TIME_RANGE.key)),this.selectedTimeRange(Constants.TIME_RANGE_PLACE_HOLDER)}},{key:"_initValidation",value:function(){var e=this
...
return{cars:t,date:this.dateMoment.toDate(),location:i,prepaid:e,price:this.discountedTotal(),services:this._buildServicesArray(),timeEstimate:this._getTimeEstimate(),timeRange:this.selectedTimeRange().range,timeRangeKey:this.selectedTimeRange().key,description:this.description()}}},{key:"_makeSubscriptionSchema",value:function(e){for(var t=this.SlectedCars,i=_.find(this.locations(),function(e){return e.selected()}),n=this.selectedSubInterval()*this.selectedSubSpan().days,o=Math.round(365/n),r=n,s=[],a=0;o>a;a++){var l=new Date(e)
