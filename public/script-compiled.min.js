...
e-=e*i}return Math.floor(e)}),this.orderSummary=ko.computed(function(){var e="",t=$.validator.format("<strong>{0} between {1}</strong><hr>",n.dateMoment?n.dateMoment.format("ddd MMM Do"):"",n.selectedTimeRange().range)
