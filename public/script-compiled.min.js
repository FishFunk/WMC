...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),spinner=null,Bootstrapper=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"Run",value:function(){function e(){var e=$(this),t=e.find(".modal-dialog")
e.css("display","block"),t.css("margin-top",Math.max(0,($(window).height()-t.height())/2))}var t=$.Deferred()
return spinner=new LoadingSpinner,$(".navbar-collapse ul li a").click(function(){$(".navbar-toggle:visible").click()}),$("body").scrollspy({target:".navbar-fixed-top"}),$(".modal").on("show.bs.modal",e),$(window).on("resize",function(){$(".modal:visible").each(e)}),async.series([function(e){$("#order-form-tmpl").load("./templates/order-form-tmpl.html",function(t,i,n){"error"===i?e("Application failed to initialize."):e()})},function(e){$("#vehicle-tmpl").load("./templates/vehicle-tmpl.html",function(t,i,n){"error"===i?e("Application failed to initialize."):e()})},function(e){$("#location-tmpl").load("./templates/location-tmpl.html",function(t,i,n){"error"===i?e("Application failed to initialize."):e()})},function(e){var t=new LocalStorageHelper(sessionStorage),i=new WebService,n=new OrderFormViewModel(t,i),r=new LogInViewModel(t,i),a=new MainViewModel(t,r,n)
ko.applyBindings(a),i.GetAllAppointments().then(function(i){var n=_.groupBy(i,function(e){return moment(e.date).format("MM/DD/YYYY")})
...
spinner.Show(),async.series([this._verifyUser.bind(this),this._executeCharge.bind(this,e),this._updateUserData.bind(this),this._sendEmailConfirmation.bind(this)],function(e){e?t._onOrderFailure(e):t._onOrderSuccess()})}catch(i){this._onOrderFailure(i)}}},{key:"_onOrderFailure",value:function(e){spinner.Hide(),bootbox.alert(Constants.ORDER_FAILURE_MSG),console.log(e)}},{key:"_onOrderSuccess",value:function(){spinner.Hide(),bootbox.alert(Constants.ORDER_SUCCESS_MSG),this.OnFormCancel()}},{key:"_sendEmailConfirmation",value:function(e){this.webSvc.SendConfirmationEmail(this.storageHelper.LoggedInUser.email,this.storageHelper.LoggedInUser.appointments).then(function(){return e()}).fail(function(t){return e(t)})}},{key:"_verifyUser",value:function(e){var t=this
...
else{var n=t._makeTempUserSchema()
t.storageHelper.LoggedInUser=i,t.webSvc.CreateUser(n).then(function(){return e()}).fail(function(t){return e(t)})}}).fail(function(t){return e(t)})}},{key:"_executeCharge",value:function(e,t){this.webSvc.ExecuteCharge(e,100*this.orderTotal(),this.last()).then(function(){return t()}).fail(function(e){return t(e)})}},{key:"_updateUserData",value:function(e){var t=this.storageHelper.LoggedInUser,i=this._makeAppointmentSchema()
