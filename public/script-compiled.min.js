...
n&&(e+=t*n.multiplier)}}),Math.floor(e)}),this.orderSummary=ko.computed(function(){var e=""
...
_.each(t,function(e){return e.selected=ko.observable(!1)}),_.each(i,function(e){return e.selected=ko.observable(!1)}),this.locations(t),this.cars(i),this.email(e.email||""),this.phone(e.phone||""),this.first(e.firstName||""),this.last(e.lastName||""),e.email&&this.disableEmailInput(!0),$("#phone").trigger("input")}}},{key:"_onDatepickerChange",value:function(e){e&&(this.dateMoment=e.date,this._updatePickerAndTimerangeOptions(e.date))}},{key:"_updatePickerAndTimerangeOptions",value:function(e){var t=moment().hour(),i=moment().format(Constants.DATE_FORMAT),n=e.format(Constants.DATE_FORMAT),r=this.storageHelper.AppointmentsByDate[n]||[],o=Constants.MAX_JOB_TIME_PER_INTERVAL,a=_.filter(r,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),s=_.filter(r,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),l=_.filter(r,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),c=_.filter(r,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
Constants.MORNING_TIME_RANGE.disabled(_.reduce(a,function(e,t){return e+t.timeEstimate},0)>o||n==i&&t>=11),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(s,function(e,t){return e+t.timeEstimate},0)>o||n==i&&t>=14),Constants.EVENING_TIME_RANGE.disabled(_.reduce(l,function(e,t){return e+t.timeEstimate},0)>o||n==i&&t>=17),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(c,function(e,t){return e+t.timeEstimate},0)>o||n==i&&t>=20)
