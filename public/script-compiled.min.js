...
this.carYear=ko.observable(this.carYears[1]),this.first=ko.observable(""),this.last=ko.observable(""),this.email=ko.observable(""),this.phone=ko.observable(""),this.showAddLocationForm=ko.observable(!1),this.locations=ko.observableArray([]),this.locationTitleOptions=["Home","Work","Other"],this.title=ko.observable(this.locationTitleOptions[0]),this.street=ko.observable(""),this.city=ko.observable(""),this.state=ko.observable(""),this.zip=ko.observable(this.storageHelper.ZipCode),this.couponCode=ko.observable(""),this.coupon=ko.observable(null),this.orderTotal=ko.computed(function(){var e=0,t=parseFloat((n.addWash()?n.WASH_COST:0)+(n.addShine()&&n.addWash()?n.TIRE_SHINE_COST:0)+(n.addWax()&&n.addWash()?n.WAX_COST:0)+(n.addInterior()?n.INTERIOR_COST:0))
if(n.cars().forEach(function(i){if(i.selected()){var n=_.find(Configuration.CAR_SIZES,function(e){return e.size==i.size||e.multiplier==i.multiplier})
n&&(e+=t*n.multiplier)}}),n.coupon())if(100==n.coupon().discountPercentage)e-=n.WASH_COST
else{var i=n.coupon().discountPercentage/100
e-=e*i}return e.toFixed(2)}),this.orderSummary=ko.computed(function(){var e="",t=$.validator.format("<strong>{0} between {1}</strong><hr>",n.dateMoment?n.dateMoment.format("ddd MMM Do"):"",n.selectedTimeRange().range||"")
return n.coupon()&&(e=100==n.coupon().discountPercentage?"Wow! A free wash! Now that's a sweet deal!":"Promo discount: "+n.couponCode().discountPercentage.toString()+"%"),n.cars().forEach(function(e){if(e.selected()){var i=_.find(Configuration.CAR_SIZES,function(t){return t.size==e.size||t.multiplier==e.multiplier})
...
$("#invalid-coupon-alert").hide(),$("#success-coupon-alert").hide(),this.couponCode&&this.couponCode().length>0&&this.webSvc.VerifyCoupon(this.couponCode()).then(function(t){t?($("#success-coupon-alert").show(),e.coupon(t)):$("#invalid-coupon-alert").show()}).fail(function(e){console.log(e)})}},{key:"_openCheckout",value:function(){this.stripeHandler.open({key:"pk_test_luqEThs0vblV173fgAHgPZBG",name:"WMC Checkout",amount:100*this.orderTotal(),zipCode:!0,email:this.email()})}},{key:"_completeOrder",value:function(e){try{var t=this
spinner.Show(),async.waterfall([e?this._executeCharge.bind(this,e):function(e){e()},this._verifyUser.bind(this),this._updateUserData.bind(this),this._sendEmailConfirmation.bind(this)],function(e){e===Constants.CHARGE_FAILURE_MARKER?(t.incompleteFormMsg("That card information didn't work."),$("#incomplete-form-alert").show()):e?t._onOrderFailure(e):t._onOrderSuccess()})}catch(i){this._onOrderFailure(i)}}},{key:"_onOrderFailure",value:function(e){this.$orderFormModal.modal("hide"),setTimeout(function(){spinner.Hide(),dialogPresenter.ShowOrderFailure(),console.log(e)},200)}},{key:"_onOrderSuccess",value:function(){this.OnFormCancel(),setTimeout(function(){spinner.Hide(),dialogPresenter.ShowOrderSuccess()},200)}},{key:"_sendEmailConfirmation",value:function(e,t,i){this.webSvc.SendConfirmationEmail(e,t).then(function(){return i()}).fail(function(e){return i(e)})}},{key:"_verifyUser",value:function(e){var t=this
...
t.webSvc.CreateUser(n).then(function(){return e(null,n)}).fail(function(t){return e(t)})}}).fail(function(t){return e(t)})}},{key:"_executeCharge",value:function(e,t){this.webSvc.ExecuteCharge(e,100*this.orderTotal(),this.last()).then(function(){return t()}).fail(function(e){console.log(e),t(Constants.CHARGE_FAILURE_MARKER)})}},{key:"_updateUserData",value:function(e,t){var i=this._makeAppointmentSchema()
null!=e.appointments?e.appointments.push(i):e.appointments=[i],e.cars=this.cars(),e.phone=this.phone(),e.locations=this.locations(),e.firstName=this.first(),e.lastName=this.last(),this.webSvc.UpdateUser(e).then(function(){return t(null,e.email,i)}).fail(function(e){return t(e)})}},{key:"_prePopulateUserData",value:function(){var e=this.storageHelper.LoggedInUser
