...
t.LoggedInUser
this.TIRE_SHINE_COST=Constants.TIRE_SHINE_DETAILS.price,this.INTERIOR_COST=Constants.INTERIOR_DETAILS.price,this.WAX_COST=Constants.WAX_DETAILS.price,this.WASH_COST=Constants.WASH_DETAILS.price,this.disableEmailInput=ko.observable(!1),this.addShine=ko.observable(!1),this.addWax=ko.observable(!1),this.addInterior=ko.observable(!1),this.showBillingAddress=ko.observable(!1),this.description=ko.observable(""),this.timeRangeOptions=[Constants.MORNING_TIME_RANGE,Constants.AFTERNOON_TIME_RANGE,Constants.EVENING_TIME_RANGE,Constants.NIGHT_TIME_RANGE],this.selectedTimeRange=ko.observable(this.timeRangeOptions[0]),this.date=ko.observable(moment().format(Constants.DATE_FORMAT)),this.showAddVehicleForm=ko.observable(!1),this.cars=ko.observableArray([]),this.make=ko.observable(""),this.model=ko.observable(""),this.color=ko.observable(""),this.tag=ko.observable(""),this.carSizes=Constants.CAR_SIZES,this.selectedCarSize=ko.observable(this.carSizes[0]),this.carYears=[]
for(var r=(new Date).getFullYear()+1,a=0;25>a;a++)this.carYears.push((r-a).toString())
...
e.selected(!0),this.cars.push(e),this.$addVehicleForm.find("input").val(""),this.showAddVehicleForm(!1)}}},{key:"OnClickVehiclePanel",value:function(e,t){t.selected(!t.selected())}},{key:"OnDeleteVehiclePanel",value:function(e,t){e.cars(_.reject(e.cars(),function(e){return _.isEqual(e,t)}))}},{key:"OnClickLocationPanel",value:function(e,t){_.each(e.locations(),function(e){e.selected(!1)}),t.selected(!0)}},{key:"OnDeleteLocationPanel",value:function(e,t){e.locations(_.reject(e.locations(),function(e){return _.isEqual(e,t)}))}},{key:"OnSubmit",value:function(e){var t=_.filter(this.cars(),function(e){return e.selected()})
if(0===t.length)return void bootbox.alert("Please add and select at least one vehicle.")
var i=_.find(this.locations(),function(e){return e.selected()})
return i?Utils.VerifyZip(i.zip)?void(this.$orderDetailsForm.valid()&&(e?this._openCheckout():this._completeOrder())):void bootbox.alert(Constants.BAD_ZIP_MSG):void bootbox.alert("Please add and select a location.")}},{key:"OnFormCancel",value:function(){try{this.$orderFormModal.modal("hide"),window.location="#page-top",this.addShine(!1),this.addWax(!1),this.addInterior(!1),this.showBillingAddress(!1),this.description(""),this.showAddVehicleForm(!1),this.showAddLocationForm(!1),$("#datetimepicker").data("DateTimePicker").date(new Date),this.selectedCarSize(this.carSizes[0]),this.selectedTimeRange(this.timeRangeOptions[0]),this.carYear(this.carYears[1]),this.$orderDetailsForm.validate().resetForm()}catch(e){console.log("Failed to reset fields OnFormCancel()"),console.log(e)}}},{key:"_openCheckout",value:function(){this.stripeHandler.open({key:"pk_test_luqEThs0vblV173fgAHgPZBG",name:"WMC",description:"2 widgets",amount:100*this.orderTotal(),zipCode:!0,email:this.email()})}},{key:"_completeOrder",value:function(e){try{var t=this
...
_.each(t,function(e){return e.selected=ko.observable(!1)}),_.each(i,function(e){return e.selected=ko.observable(!1)}),this.locations(t),this.cars(i),this.email(e.email||""),this.phone(e.phone||""),this.first(e.firstName||""),this.last(e.lastName||""),e.email&&this.disableEmailInput(!0),$("#phone").trigger("input")}}},{key:"_onDatepickerChange",value:function(e){this._updatePickerAndTimerangeOptions(e.date)}},{key:"_updatePickerAndTimerangeOptions",value:function(e){var t=moment().hour(),i=moment().format(Constants.DATE_FORMAT)
this.date(e),$("#datetimepicker").data("DateTimePicker").date(e)
var n=this.storageHelper.AppointmentsByDate[e]||[],r=Constants.MAX_JOB_TIME_PER_INTERVAL,a=_.filter(n,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),o=_.filter(n,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),s=_.filter(n,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),l=_.filter(n,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
Constants.MORNING_TIME_RANGE.disabled(_.reduce(a,function(e,t){return e+t.timeEstimate},0)>r||e==i&&t>11),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(o,function(e,t){return e+t.timeEstimate},0)>r||e==i&&t>14),Constants.EVENING_TIME_RANGE.disabled(_.reduce(s,function(e,t){return e+t.timeEstimate},0)>r||e==i&&t>17),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(l,function(e,t){return e+t.timeEstimate},0)>r||e==i&&t>20)
for(var c=0;c<this.timeRangeOptions.length;c++){var u=this.timeRangeOptions[c]
if(!u.disabled()){this.selectedTimeRange(u)
