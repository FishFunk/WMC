...
Constants.MORNING_TIME_RANGE.disabled(_.reduce(a,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=9),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(s,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=12),Constants.EVENING_TIME_RANGE.disabled(_.reduce(l,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=15),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(c,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=18),this.selectedTimeRange(Constants.TIME_RANGE_PLACE_HOLDER)}},{key:"_initValidation",value:function(){var e=this
