...
var t=moment().hour(),i=moment().format(Configuration.DATE_FORMAT),n=e.format(Configuration.DATE_FORMAT),o=e.day(),r=_.find(Configuration.SCHEDULE,function(e){return e.day===o}),a=this.storageHelper.AppointmentsByDate[n]||[],s=Configuration.MAX_JOB_TIME_PER_INTERVAL,l=_.filter(a,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),c=_.filter(a,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),u=_.filter(a,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),d=_.filter(a,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
Constants.MORNING_TIME_RANGE.disabled(_.reduce(l,function(e,t){return e+t.timeEstimate},0)>s||n==i&&t>=9||_.contains(r.blockedTimeSlots,Constants.MORNING_TIME_RANGE.key)),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(c,function(e,t){return e+t.timeEstimate},0)>s||n==i&&t>=12||_.contains(r.blockedTimeSlots,Constants.AFTERNOON_TIME_RANGE.key)),Constants.EVENING_TIME_RANGE.disabled(_.reduce(u,function(e,t){return e+t.timeEstimate},0)>s||n==i&&t>=15||_.contains(r.blockedTimeSlots,Constants.EVENING_TIME_RANGE.key)),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(d,function(e,t){return e+t.timeEstimate},0)>s||n==i&&t>=18||_.contains(r.blockedTimeSlots,Constants.NIGHT_TIME_RANGE.key)),this.selectedTimeRange(Constants.TIME_RANGE_PLACE_HOLDER)}},{key:"_initValidation",value:function(){var e=this
