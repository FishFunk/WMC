...
return n.coupon()&&(t=100==n.coupon().discountPercentage?"Wow! A free wash! Now that's a sweet deal!":"Promo discount: "+n.couponCode().discountPercentage.toString()+"%"),n.cars().forEach(function(i){if(i.selected()){var o=_.find(Configuration.CAR_SIZES,function(e){return e.size==i.size||e.multiplier==i.multiplier})
