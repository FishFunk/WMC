...
return n.cars().forEach(function(i){if(i.selected()){var n=_.find(Configuration.CAR_SIZES,function(e){return e.size==i.size||e.multiplier==i.multiplier})
n&&(e+=t*n.multiplier)}}),parseFloat(e.toFixed(2))}),this.discountedTotal=ko.computed(function(){var e=n.orderTotal()
if(!n.coupon())return e.toFixed(2)
if(100==n.coupon().discountPercentage)e-=n.WASH_COST
else{var t=n.coupon().discountPercentage/100
e-=e*t}return parseFloat(e.toFixed(2))}),this.orderSummary=ko.computed(function(){var e="",t=""
return n.hideSubscriptionForm()?n.dateMoment&&(t=$.validator.format("<strong>{0} {1}</strong><hr>",n.dateMoment.format("ddd MMM Do"),n.selectedTimeRange().range)):n.dateMoment&&(t=$.validator.format("<strong>{0} every {1} {2} starting {3}</strong><hr>",n.selectedTimeRange().range,n.selectedSubInterval(),n.selectedSubSpan().display,n.dateMoment.format("ddd MMM Do"))),n.coupon()&&(e=100==n.coupon().discountPercentage?"Wow! A free wash! Now that's a sweet deal!":"Promo discount: "+n.coupon().discountPercentage.toString()+"%"),n.cars().forEach(function(e){if(e.selected()){var i=_.find(Configuration.CAR_SIZES,function(t){return t.size==e.size||t.multiplier==e.multiplier})
t+=$.validator.format("<strong>{0} {1}</strong><br>{2}{3}{4}{5}{6}{7}<br>",e.make,e.model,n.addWash()?"Exterior Hand Wash<br>":"",n.addShine()&&n.addWash()?"Deep Tire Clean & Shine<br>":"",n.addWax()&&n.addWash()?"Hand Wax & Buff<br>":"",n.addInterior()?"Full Interior Cleaning<br>":"",i.size,i.multiplier>1?" - additional "+Math.round(100*(i.multiplier-1)).toString()+"%":"")}}),t+=e})}return _createClass(e,[{key:"OnAfterRender",value:function(e,t){t.$addVehicleForm=$("#add-vehicle-form"),t.$addLocationForm=$("#add-location-form"),t.$contactDetailsForm=$("#contact-details-form"),t.$orderDetailsForm=$("#order-details-form"),$("#phone").mask("(999) 999-9999? ext:99999",{placeholder:" "}),$("#datetimepicker").datetimepicker({minDate:moment().subtract(1,"days"),maxDate:moment().add(60,"days"),format:Configuration.DATE_FORMAT,allowInputToggle:!0,focusOnShow:!1,ignoreReadonly:!0}).on("dp.change",t._onDatepickerChange.bind(t)),t._initValidation()}},{key:"OnAddNewLocation",value:function(){this.showAddLocationForm(!0)}},{key:"OnCancelNewLocation",value:function(){this.$addVehicleForm.find("input").val(""),this.$addLocationForm.validate().resetForm(),this.showAddLocationForm(!1)}},{key:"OnSaveNewLocation",value:function(){if(this.$addLocationForm.valid()){var e=this._makeLocationSchema()
...
if(!this.$orderDetailsForm.valid())return this.incompleteFormMsg("Please select a date of service."),void $("#incomplete-form-alert").show()
if(!this.selectedTimeRange().range)return this.incompleteFormMsg("Please select a valid time range."),void $("#incomplete-form-alert").show()
...
var t=_.filter(this.cars(),function(e){return e.selected()})
if(0===t.length)return this.incompleteFormMsg("Please select at least one vehicle to service."),void $("#incomplete-form-alert").show()
...
Constants.MORNING_TIME_RANGE.disabled(_.reduce(a,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=11),Constants.AFTERNOON_TIME_RANGE.disabled(_.reduce(s,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=14),Constants.EVENING_TIME_RANGE.disabled(_.reduce(l,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=17),Constants.NIGHT_TIME_RANGE.disabled(_.reduce(c,function(e,t){return e+t.timeEstimate},0)>r||n==i&&t>=20),this.selectedTimeRange(Constants.TIME_RANGE_PLACE_HOLDER)}},{key:"_initValidation",value:function(){this.$orderDetailsForm.validate({rules:{date:"required"},errorPlacement:function(){}}),this.$contactDetailsForm.validate({rules:{first:"required",last:"required",date:"required",email:{required:!0,email:!0},phone:"required"},messages:{email:"Please enter a valid email address."}}),this.$addVehicleForm.validate({rules:{make:"required",model:"required",color:"required"}}),this.$addLocationForm.validate({rules:{street:"required",city:"required",state:"required",zip:"required"}})}},{key:"_makeGuestUserSchema",value:function(){return{isGuest:!0,email:this.email(),pwd:Utils.GenerateUUID()}}},{key:"_makeCarSchema",value:function(){return{color:this.color(),make:this.make(),model:this.model(),size:this.selectedCarSize().size,tag:this.tag(),year:parseInt(this.carYear()),selected:ko.observable(!1)}}},{key:"_makeAppointmentSchema",value:function(e){var t=_.filter(this.cars(),function(e){return e.selected()}),i=_.find(this.locations(),function(e){return e.selected()})
return{cars:t,date:this.dateMoment.toDate(),location:i,prepaid:e,price:this.discountedTotal(),services:this._buildServicesArray(),timeEstimate:this._getTimeEstimate(),timeRange:this.selectedTimeRange().range,timeRangeKey:this.selectedTimeRange().key,description:this.description()}}},{key:"_makeSubscriptionSchema",value:function(e){for(var t=_.filter(this.cars(),function(e){return e.selected()}),i=_.find(this.locations(),function(e){return e.selected()}),n=this.selectedSubInterval()*this.selectedSubSpan().days,o=Math.round(365/n),r=n,a=[],s=0;o>s;s++){var l=new Date(e)
...
return this.addWash()&&e.push(Configuration.WASH_DETAILS.title),this.addShine()&&e.push(Configuration.TIRE_SHINE_DETAILS.title),this.addWax()&&e.push(Configuration.WAX_DETAILS.title),this.addInterior()&&e.push(Configuration.INTERIOR_DETAILS.title),e}}]),e}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
