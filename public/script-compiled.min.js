...
return this.addWash()&&e.push(Configuration.WASH_DETAILS.title),this.addShine()&&e.push(Configuration.TIRE_SHINE_DETAILS.title),this.addWax()&&e.push(Configuration.WAX_DETAILS.title),this.addInterior()&&e.push(Configuration.INTERIOR_DETAILS.title),e}},{key:"_buildServicesSummary",value:function(){var e=""
return this.addWash()&&(e+=Configuration.WASH_DETAILS.title+"<br>"),this.addShine()&&(e+=Configuration.TIRE_SHINE_DETAILS.title+"<br>"),this.addWax()&&(e+=Configuration.WAX_DETAILS.title+"<br>"),this.addInterior()&&(e+=Configuration.INTERIOR_DETAILS.title+"<br>"),e}}]),e}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
