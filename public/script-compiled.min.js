...
spinner=new LoadingSpinner,$(".navbar-collapse ul li a").click(function(){$(".navbar-toggle:visible").click()}),$("body").scrollspy({target:".navbar-fixed-top"}),$(".modal").on("show.bs.modal",e),$(window).on("resize",function(){$(".modal:visible").each(e)})
...
spinner.Show(),async.series([e?this._executeCharge.bind(this,e):function(e){e()},this._verifyUser.bind(this),this._updateUserData.bind(this),this._sendEmailConfirmation.bind(this)],function(e){e?t._onOrderFailure(e):t._onOrderSuccess()})}catch(i){this._onOrderFailure(i)}}},{key:"_onOrderFailure",value:function(e){spinner.Hide(),bootbox.alert(Constants.ORDER_FAILURE_MSG),console.log(e)}},{key:"_onOrderSuccess",value:function(){spinner.Hide(),bootbox.alert(Constants.ORDER_SUCCESS_MSG),this.OnFormCancel()}},{key:"_sendEmailConfirmation",value:function(e){this.webSvc.SendConfirmationEmail(this.storageHelper.LoggedInUser.email,this.storageHelper.LoggedInUser.appointments).then(function(){return e()}).fail(function(t){return e(t)})}},{key:"_verifyUser",value:function(e){var t=this
