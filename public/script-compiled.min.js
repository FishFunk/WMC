"use strict"
function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),spinner=null,environment="debug",dialogPresenter=null,Bootstrapper=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"Run",value:function(){function e(){var e=$(this),t=e.find(".modal-dialog")
...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),ASYNC_INTERUPTION_MARKER="ASYNC_INTERUPTION_MARKER",DATE_FORMAT="MM/DD/YY",DEFAULT_JOB_TIME_MINS=120,MAX_JOB_TIME_PER_DAY_MINS=720,MAX_JOB_TIME_PER_INTERVAL=180,WASH_DETAILS={title:"Hand wash",time:30,price:19},TIRE_SHINE_DETAILS={title:"Tire shine",time:30,price:20},INTERIOR_DETAILS={title:"Interior cleaning",time:50,price:40},WAX_DETAILS={title:"Hand wax & buff",time:50,price:30},MORNING_TIME_RANGE={range:"9:00 - 12:00 PM",key:1,disabled:ko.observable(!1)},AFTERNOON_TIME_RANGE={range:"12:00 - 3:00 PM",key:2,disabled:ko.observable(!1)},EVENING_TIME_RANGE={range:"3:00 - 6:00 PM",key:3,disabled:ko.observable(!1)},NIGHT_TIME_RANGE={range:"6:00 - 9:00 PM",key:4,disabled:ko.observable(!1)},CAR_SIZES=[{size:"Compact (2-4 door)",multiplier:1},{size:"SUV (5-door)",multiplier:1.2},{size:"XXL",multiplier:1.4}],ZIP_WHITE_LIST=["22314","22301","22305","22302","22304","22202","22206","22311","22312","22204","22041","22211","22201","22203","22209","22044","22151","22150","22152","22153","22015","22205","22042","22046","22003","22207","22213","22031","22043","22027","22101","22182","22030","22032","22039","20124"],Constants=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"TIRE_SHINE_DETAILS",get:function(){return TIRE_SHINE_DETAILS}},{key:"INTERIOR_DETAILS",get:function(){return INTERIOR_DETAILS}},{key:"WAX_DETAILS",get:function(){return WAX_DETAILS}},{key:"WASH_DETAILS",get:function(){return WASH_DETAILS}},{key:"ZIP_WHITE_LIST",get:function(){return ZIP_WHITE_LIST}},{key:"MORNING_TIME_RANGE",get:function(){return MORNING_TIME_RANGE}},{key:"AFTERNOON_TIME_RANGE",get:function(){return AFTERNOON_TIME_RANGE}},{key:"EVENING_TIME_RANGE",get:function(){return EVENING_TIME_RANGE}},{key:"NIGHT_TIME_RANGE",get:function(){return NIGHT_TIME_RANGE}},{key:"CAR_SIZES",get:function(){return CAR_SIZES}},{key:"ORDER_SUCCESS_MSG",get:function(){return ORDER_SUCCESS_MSG}},{key:"ORDER_FAILURE_MSG",get:function(){return ORDER_FAILURE_MSG}},{key:"BAD_ZIP_MSG",get:function(){return BAD_ZIP_MSG}},{key:"ASYNC_INTERUPTION_MARKER",get:function(){return ASYNC_INTERUPTION_MARKER}},{key:"MAX_JOB_TIME_PER_INTERVAL",get:function(){return MAX_JOB_TIME_PER_INTERVAL}},{key:"DATE_FORMAT",get:function(){return DATE_FORMAT}}]),e}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i]
...
_.each(o,function(e){n+=e.timeEstimate?e.timeEstimate:Contsants.DEFAULT_JOB_TIME_MINS}),n>Constants.MAX_JOB_TIME_PER_DAY_MINS&&t.push(_.first(o).date)}return t}},{key:"VerifyZip",value:function(e){return _.contains(Constants.ZIP_WHITE_LIST,e.trim())}},{key:"IsStrEqual",value:function(e,t){var i=e.trim().toUpperCase(),n=t.trim().toUpperCase()
...
var n=this
this.stripeHandler=StripeCheckout.configure({key:"production"==environment?"pk_live_aULtlGy6YPvc94K5Hjvqwokg":"pk_test_luqEThs0vblV173fgAHgPZBG",image:"/img/square_logo.png",locale:"auto",token:this._completeOrder.bind(this)}),$(window).on("popstate",function(){n.stripeHandler.close()}),this.webSvc=i,this.storageHelper=t,this.$orderFormModal=$("#order-form-modal"),this.$orderFormModal.on("show.bs.modal",function(){n._prePopulateUserData()}),this.TIRE_SHINE_COST=Constants.TIRE_SHINE_DETAILS.price,this.INTERIOR_COST=Constants.INTERIOR_DETAILS.price,this.WAX_COST=Constants.WAX_DETAILS.price,this.WASH_COST=Constants.WASH_DETAILS.price,this.disableEmailInput=ko.observable(!1),this.incompleteFormMsg=ko.observable(""),this.addShine=ko.observable(!1),this.addWax=ko.observable(!1),this.addInterior=ko.observable(!1),this.showBillingAddress=ko.observable(!1),this.description=ko.observable(""),this.timeRangeOptions=[Constants.MORNING_TIME_RANGE,Constants.AFTERNOON_TIME_RANGE,Constants.EVENING_TIME_RANGE,Constants.NIGHT_TIME_RANGE],this.selectedTimeRange=ko.observable(this.timeRangeOptions[0]),this.dateMoment=null,this.showAddVehicleForm=ko.observable(!1),this.cars=ko.observableArray([]),this.make=ko.observable(""),this.model=ko.observable(""),this.color=ko.observable(""),this.tag=ko.observable(""),this.carSizes=Constants.CAR_SIZES,this.selectedCarSize=ko.observable(this.carSizes[0]),this.carYears=[]
for(var o=(new Date).getFullYear()+1,r=0;25>r;r++)this.carYears.push((o-r).toString())
this.carYear=ko.observable(this.carYears[1]),this.first=ko.observable(""),this.last=ko.observable(""),this.email=ko.observable(""),this.phone=ko.observable(""),this.showAddLocationForm=ko.observable(!1),this.locations=ko.observableArray([]),this.locationTitleOptions=["Home","Work","Other"],this.title=ko.observable(this.locationTitleOptions[0]),this.street=ko.observable(""),this.city=ko.observable(""),this.state=ko.observable(""),this.zip=ko.observable(this.storageHelper.ZipCode),this.couponCode=ko.observable(""),this.coupon=ko.observable(null),this.orderTotal=ko.computed(function(){var e=0,t=parseFloat(n.WASH_COST+(n.addShine()?n.TIRE_SHINE_COST:0)+(n.addWax()?n.WAX_COST:0)+(n.addInterior()?n.INTERIOR_COST:0))
if(n.cars().forEach(function(i){if(i.selected()){var n=_.find(Constants.CAR_SIZES,function(e){return e.size==i.size||e.multiplier==i.multiplier})
...
return n.coupon()&&(t=100==n.coupon().discountPercentage?"First Timer Discount - First Wash Free!":"Promo discount: "+n.couponCode().discountPercentage.toString()+"%"),n.cars().forEach(function(i){if(i.selected()){var o=_.find(Constants.CAR_SIZES,function(e){return e.size==i.size||e.multiplier==i.multiplier})
e+=$.validator.format("<strong>{7} between {8}</strong><hr><strong>{5} {6}</strong><br>Exterior Hand Wash<br>{0}{1}{2}{3} = {4}x cost multiplier.<br>{9}",n.addShine()?"Deep Tire Clean & Shine<br>":"",n.addWax()?"Hand Wax & Buff<br>":"",n.addInterior()?"Full Interior Cleaning<br>":"",o.size,o.multiplier.toString(),i.make,i.model,n.dateMoment.format("ddd MMM Do"),n.selectedTimeRange().range,t)}}),e})}return _createClass(e,[{key:"OnAfterRender",value:function(e,t){t.$addVehicleForm=$("#add-vehicle-form"),t.$addLocationForm=$("#add-location-form"),t.$contactDetailsForm=$("#contact-details-form"),t.$orderDetailsForm=$("#order-details-form"),$("#phone").mask("(999) 999-9999? ext:99999",{placeholder:" "}),$("#datetimepicker").datetimepicker({minDate:moment().subtract(1,"days"),maxDate:moment().add(60,"days"),format:Constants.DATE_FORMAT,allowInputToggle:!0,focusOnShow:!1,ignoreReadonly:!0}).on("dp.change",t._onDatepickerChange.bind(t)),t._initValidation()}},{key:"OnAddNewLocation",value:function(){this.showAddLocationForm(!0)}},{key:"OnCancelNewLocation",value:function(){this.$addVehicleForm.find("input").val(""),this.$addLocationForm.validate().resetForm(),this.showAddLocationForm(!1)}},{key:"OnSaveNewLocation",value:function(){if(this.$addLocationForm.valid()){var e=this._makeLocationSchema()
...
return i?Utils.VerifyZip(i.zip)?this.$contactDetailsForm.valid()?void(e?this._openCheckout():this._completeOrder()):(this.incompleteFormMsg("Please complete the contact information."),void $("#incomplete-form-alert").show()):(this.incompleteFormMsg(Constants.BAD_ZIP_MSG),void $("#incomplete-form-alert").show()):(this.incompleteFormMsg("Please select your desired location."),void $("#incomplete-form-alert").show())}},{key:"OnFormCancel",value:function(){try{this.storageHelper.LoggedInUser=null,this.$orderFormModal.modal("hide"),window.location="#page-top",this._resetObservables(),this.$orderDetailsForm.validate().resetForm(),this.$contactDetailsForm.validate().resetForm(),$("#incomplete-form-alert").hide(),$("#invalid-coupon-alert").hide(),$("#success-coupon-alert").hide()}catch(e){console.log("Failed to reset fields OnFormCancel()"),console.log(e)}}},{key:"OnApplyCoupon",value:function(){var e=this
...
spinner.Show(),async.series([e?this._executeCharge.bind(this,e):function(e){e()},this._verifyUser.bind(this),this._updateUserData.bind(this),this._sendEmailConfirmation.bind(this)],function(e){e?t._onOrderFailure(e):t._onOrderSuccess()})}catch(i){this._onOrderFailure(i)}}},{key:"_onOrderFailure",value:function(e){spinner.Hide(),dialogPresenter.ShowOrderFailure(),console.log(e)}},{key:"_onOrderSuccess",value:function(){spinner.Hide(),dialogPresenter.ShowOrderSuccess(),this.OnFormCancel()}},{key:"_sendEmailConfirmation",value:function(e){this.webSvc.SendConfirmationEmail(this.storageHelper.LoggedInUser.email,this.storageHelper.LoggedInUser.appointments).then(function(){return e()}).fail(function(t){return e(t)})}},{key:"_verifyUser",value:function(e){var t=this
...
_.each(t,function(e){return e.selected=ko.observable(!1)}),_.each(i,function(e){return e.selected=ko.observable(!1)}),this.locations(t),this.cars(i),this.email(e.email||""),this.phone(e.phone||""),this.first(e.firstName||""),this.last(e.lastName||""),e.email&&this.disableEmailInput(!0),$("#phone").trigger("input")}}},{key:"_resetObservables",value:function(){this.disableEmailInput(!1),this.incompleteFormMsg(""),this.addShine(!1),this.addWax(!1),this.addInterior(!1),this.showBillingAddress(!1),this.description=ko.observable(""),this.selectedTimeRange(this.timeRangeOptions[0]),this.dateMoment=null,this.showAddVehicleForm(!1),this.cars([]),this.make(""),this.model(""),this.color(""),this.tag(""),this.selectedCarSize(this.carSizes[0]),this.carYear(this.carYears[1]),this.first(""),this.last(""),this.email(""),this.phone(""),this.showAddLocationForm(!1),this.locations([]),this.title(this.locationTitleOptions[0]),this.street(""),this.city(""),this.state(""),this.zip(""),this.couponCode(""),this.coupon(null)}},{key:"_onDatepickerChange",value:function(e){e&&(this.dateMoment=e.date,this._updatePickerAndTimerangeOptions(e.date))}},{key:"_updatePickerAndTimerangeOptions",value:function(e){var t=moment().hour(),i=moment().format(Constants.DATE_FORMAT),n=e.format(Constants.DATE_FORMAT),o=this.storageHelper.AppointmentsByDate[n]||[],r=Constants.MAX_JOB_TIME_PER_INTERVAL,s=_.filter(o,function(e){return e.timeRangeKey===Constants.MORNING_TIME_RANGE.key}),a=_.filter(o,function(e){return e.timeRangeKey===Constants.AFTERNOON_TIME_RANGE.key}),l=_.filter(o,function(e){return e.timeRangeKey===Constants.EVENING_TIME_RANGE.key}),c=_.filter(o,function(e){return e.timeRangeKey===Constants.NIGHT_TIME_RANGE.key})
...
return{cars:e,date:this.dateMoment.toDate(),location:t,price:this.orderTotal(),services:this._buildServicesArray(),timeEstimate:this._getTimeEstimate(),timeRange:this.selectedTimeRange().range,timeRangeKey:this.selectedTimeRange().key,description:this.description()}}},{key:"_makeLocationSchema",value:function(){return{city:this.city(),state:this.state(),street:this.street(),title:this.title(),zip:this.zip(),selected:ko.observable(!1)}}},{key:"_getTimeEstimate",value:function(){var e=Constants.WASH_DETAILS.time
