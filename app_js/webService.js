class WebService {
	...
	SendConfirmationEmail(firstName, email, phone, newAppt){
		return this._executeAjaxCall('POST', "/api/sendConfirmationEmail", 
			{firstName: firstName, email: email, phone: phone, newAppt: newAppt})
	}
